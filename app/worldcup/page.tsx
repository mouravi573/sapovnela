...
export default function WorldCupDashboard() {
  ...
  const loadWinners = useCallback(async () => {
    try {
      ...
      setWinners(
        (data.matches ?? []).sort(
          (a: WCMarket, b: WCMarket) => b.yes_price - a.yes_price,
        ),
      );
      setStats({
        wcMarkets: data.total_wc_markets ?? 0,
        total: data.total_markets_scanned ?? 0,
      });
      setStatus("Live");
    } catch {
      setStatus("Error");
      ...
      <div style={{ maxWidth: 1040, margin: "0 auto", padding: "0 24px 80px" }}>
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
            ...
            <div className="wc-mono" style={{ fontSize: 11, color: "#4a5568" }}>
              {clock}
            </div>
          </div>
        </nav>
        ...
        >
          {[
            {
              label: "WC markets found",
              value: stats.wcMarkets,
              color: "#00c9a7",
            },
            ...
            <div
              key={s.label}
              style={{ background: "#0e1318", padding: "16px 20px" }}
            >
              <div
                className="wc-mono"
                style={{
              ...
              <div
                className="wc-mono"
                style={{ fontSize: 22, fontWeight: 600, color: s.color }}
              >
                {s.value}
              </div>
            </div>
        ...
        {tab === "winners" && (
          <div style={{ marginBottom: 32 }}>
            ...
            >
              Will [team] win the 2026 World Cup? — ranked by implied
              probability
            </div>
            <div
              style={{
            ...
            >
              <div
                className="wc-mono wc-row"
                style={{
                  display: "grid",
                  gridTemplateColumns: "32px 1fr 90px 100px 110px",
                  gap: 12,
                  alignItems: "center",
                  padding: "10px 16px",
                  fontSize: 9,
                ...
                winners.map((w, i) => {
                  ...
                  return (
                    <div
                      ...
                      className="wc-row"
                      onClick={() =>
                        prefillTrade(w.question, "YES", w.yes_price * 100)
                      }
                      style={{
                        display: "grid",
                        gridTemplateColumns: "32px 1fr 90px 100px 110px",
                    ...
                    >
                      ...
                      >
                        ${(w.volume_24h / 1_000_000).toFixed(1)}M/24h
                      </div>
                    </div>
                  );
                })
          ...
          <div style={{ marginBottom: 32 }}>
            ...
            {matches.length === 0 ? (
              ...
              >
                ...
                <div
                  className="wc-mono"
                  style={{ fontSize: 12, color: "#4a5568", lineHeight: 1.8 }}
                >
                  No individual match markets found right now.
                  <br />
              ...
              >
                {matches.map((m) => (
                  <div
                    key={m.condition_id}
                    onClick={() =>
                      prefillTrade(m.question, "YES", m.yes_price * 100)
                    }
                    style={{
                      background: "#0e1318",
                      border: "1px solid #1a2230",
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ${(m.volume_24h / 1000).toFixed(0)}K vol/24h
                      </div>
                    </div>
                  </div>
                ))}
                ...
                {trades
                  ...
                  .map((t) => (
                    ...
                    >
                      ...
                      <td className="wc-mono" style={{ padding: "13px 16px" }}>
                        ${t.size}
                      </td>
            ...
            {trades.length === 0 && (
              ...
              >
                <span style={{ fontSize: 11, color: "#4a5568" }}>
                  No trades logged yet. Click a team above to log a paper trade.
                </span>
              </div>
            )}
          </div>
