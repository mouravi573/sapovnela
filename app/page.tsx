  ...
  const instruments: InstrumentStatus[] = [
    {
      ...
      description:
        "Tournament winner odds, ranked by implied probability. Knockout stage matches resolve daily through July 19.",
      href: "/worldcup",
    },
    {
      ...
      marketsTracked: 0,
      description:
        "Polymarket strike prices vs real-time Yahoo Finance quotes. Flags markets where the real price already cleared the strike.",
      href: "/stocks",
    },
    {
      ...
      marketsTracked: 0,
      description:
        'Polymarket\'s own Fed Rates category — "Fed Decision in July?", rate cut count markets. July 29 FOMC is the next resolution catalyst.',
      href: "/fed",
    },
    {
      ...
      marketsTracked: 0,
      description:
        "Kalshi vs Polymarket price divergence scanner. Built, not yet active.",
    },
  ];
    ...
    >
      ...
      <div style={{ maxWidth: 880, margin: "0 auto", padding: "0 24px 100px" }}>
        ...
        <section style={{ marginBottom: 56 }}>
          ...
          >
            Prediction market{" "}
            <strong style={{ fontWeight: 600 }}>signal engine</strong>
          </h1>
          <p
            style={{
              fontSize: 14,
          ...
          >
            Tracks Polymarket prices against external benchmarks to surface
            mispricings. Built and operated from Tbilisi, Georgia. Paper trading
            mode — no live capital deployed.
          </p>
        </section>
        ...
        >
          <div style={{ background: "#0e1318", padding: "18px 20px" }}>
            ...
            <div
              className="root-mono"
              style={{ fontSize: 24, fontWeight: 600, color: "#00c9a7" }}
            >
              {totalCount}
            </div>
          </div>
          <div style={{ background: "#0e1318", padding: "18px 20px" }}>
            ...
            <div
              className="root-mono"
              style={{ fontSize: 24, fontWeight: 600, color: "#3dd68c" }}
            >
          ...
          <div style={{ background: "#0e1318", padding: "18px 20px" }}>
            ...
            <div
              className="root-mono"
              style={{ fontSize: 24, fontWeight: 600, color: "#f5a623" }}
            >
              PAPER
            </div>
          </div>
                ...
                >
                  ...
                  <p
                    style={{
                      ...
                      color: "#8892a4",
                      lineHeight: 1.6,
                      marginBottom: inst.status === "active" ? 12 : 0,
                    }}
                  >
                    {inst.description}
                  </p>
